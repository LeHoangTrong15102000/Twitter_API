// Điều hướng cho phần like Controller
...
export const unlikeTweetController = async (req: Request, res: Response) => {
  const { user_id } = req.body.decoded_authorization as TokenPayload
  await likeService.unlikeTweet(user_id, req.body.tweet_id)
  return res.json({
